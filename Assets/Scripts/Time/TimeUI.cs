...
public class TimeUI : MonoBehaviour
{
    ...
    {
        m_timeText.text = $"{TimeManager.m_hour}:{TimeManager.m_minute:00}"; // :00 masks the hours and the minutes with "00:" so that there are 0s present when nothing occupies either the tens or units of either the minutes or hours
    } 
}
